...
On cherche à savoir si les coefficients sont stables au cours du temps. U
tilisation de deux tests :

. . .

-   **Bai et Perron (2003)**

Il s'appuie lui même sur le test de Chow. 
...
Tests trouvés dans la littérature autour de Nyblom et Hansen (1992) : sous {{< fa brands r-project >}} `tvCoef::hansent.test()`
$$
\begin{cases}
...
{{< fa fa-solid fa-triangle-exclamation >}} Comme tout test, ils ont leurs limites, prendre les résultats avec précaution.\
