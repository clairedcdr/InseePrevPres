...
![Noyau en fonction de b](graphs_atelier/bw_anim.gif){fig-align="center"}
...
Sur `tvCoef` : documentation, gestion des retards de la variable endogène

Autour de l'étude : séminaire D2E + document de travail
