...
\\
(\beta_{0,t} + \beta_{1,t} climat\_fr_t + \beta_{2,t} \Delta climat\_fr_t) 1_{t > 2011.25} + \varepsilon_t 
$$
...
Devient :
$$
PIB_t=\begin{pmatrix}1 & climat\_fr & \Delta climat\_fr\end{pmatrix}_t\alpha
\begin{pmatrix}
\beta_0 \\
\beta_1 \\ 
\beta_2
...
Etude de 25 modèles de prévision de la production manufacturière estimés entre 1990 Q1 et 2019 Q4. 
