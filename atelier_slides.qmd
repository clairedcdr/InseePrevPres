...
Dans le cas de notre modèle exemple, Bai et Perron détecte deux ruptures en 2006 Q2 et 2011 Q2. Pur simplifier les exlications on ne retiendra que la deuxième. Le modèle suivant est alors estimé :
...
Etude de 25 modèles de prévision de la production manufacturière (?) estimés entre 1990 Q1 et 2019 Q4. Ce que l'on peut retenir : 

- In sample : la plupart des modèles sont généralement meilleurs que le modèle linéaire 

- Out of sample : les modèles espace_état sont meilleurs que le modèle linéaire en terme de RMSE pour la prévision hors échantillon. Pour ce qui est des autres modèles, plus variable d'un modèle à l'autre. Logique puisque l'objectif n'est pas de trouver un modèle magique. 
